...
import { vendorPatch, VendorFetchError, vendorGet } from "@/lib/vendor-fetch";
    ...
    <>
      ...
      <div className="mb-6 flex flex-wrap items-center gap-5 rounded-2xl border border-[var(--line)] bg-white p-6">
        ...
        <div className="flex flex-wrap gap-2">
          <span className={`rounded-lg px-3 py-1.5 text-xs font-semibold ${vendor?.status === "active"
